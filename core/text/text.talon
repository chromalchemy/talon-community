...
{user.word_formatter} <user.word>: 
    user.insert_formatted(word, word_formatter)

<user.formatters> (pace | paste): 
    user.insert_formatted(clip.text(), formatters)
    
(word | were | were it | vert | wert) <user.word>:
...
(abbreviate | abreviate | (brief | breathe)) {user.abbreviation}: 
    "{abbreviation}"

<user.formatters> (abbreviate | abreviate | (brief | breathe)) {user.abbreviation}:

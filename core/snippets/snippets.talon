...
(snip | snippet) {user.snippet}: user.insert_snippet_by_name_with_stop_at_end(snippet)
...
(snip | snippet) {user.snippet_with_phrase} <user.text>:
...
(snip | snippet) next: user.move_cursor_to_next_snippet_stop()

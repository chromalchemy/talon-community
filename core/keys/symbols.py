...
symbols = [
    ...
    Symbol("[", None,["brack", "L brack", "bracket", "L bracket", "left bracket", "square", "L square", "left square", "left box", "L box"],),
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "box",  "R box", "right box"]),

...
(talon | tellin | tell in | tallin) [voice] check [for] updates: menu.check_for_updates()
(talon | tellin | tell in | tallin) [voice] (open | view | show) log | (show | open | view) (talon | tellin | tell in | tallin) [voice] log: menu.open_log()
key(cmd-ctrl-alt-shift-d): menu.open_log()
(talon | tellin | tell in | tallin) [voice] (show | open) (rebel | repl): menu.open_repl()
(talon | tellin | tell in | tallin) [voice] home: menu.open_talon_home()
(talon | tellin | tell in | tallin) [voice] copy context pie: user.talon_add_context_clipboard_python()
(talon | tellin | tell in | tallin) [voice] copy context: user.talon_add_context_clipboard()
